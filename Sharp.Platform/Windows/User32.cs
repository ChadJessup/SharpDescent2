...
namespace Sharp.Platform.Windows
{
    ...
    internal static class User32
    {
        ...
        /// </remarks>
        [DllImport(LibraryName, CharSet = CharSet.Auto, CallingConvention = CallingConvention.StdCall)]
        ...
        ///     http://msdn.microsoft.com/library/default.asp?url=/library/en-us/winui/winui/windowsuserinterface/windowing/hooks/hookreference/hookfunctions/setwindowshookex.asp
        /// </remarks>
        [DllImport(LibraryName, CharSet = CharSet.Auto, CallingConvention = CallingConvention.StdCall, SetLastError = true)]
